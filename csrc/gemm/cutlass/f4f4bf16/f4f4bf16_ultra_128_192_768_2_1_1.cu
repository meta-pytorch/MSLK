...
at::Tensor f4f4bf16_ultra_128_192_768_2_1_1(
  ...
  if (global_scale) {
    return _f4f4bf16<NVFP4, 128, 192, 2, 1, 1, /*UseUltra=*/true>(
        XQ, WQ, x_scale, w_scale, output, global_scale);
  } else if (mxfp4_block_size == 16) {
    return _f4f4bf16<MXFP4_16, 128, 192, 2, 1, 1, /*UseUltra=*/true>(
        XQ, WQ, x_scale, w_scale, output, global_scale);
  } else {
    return _f4f4bf16<MXFP4, 128, 192, 2, 1, 1, /*UseUltra=*/true>(
        XQ, WQ, x_scale, w_scale, output, global_scale);
  }
}
