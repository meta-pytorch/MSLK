...
at::Tensor f4f4bf16_ultra_256_128_768_2_4_1(
  ...
  if (global_scale) {
    return _f4f4bf16<NVFP4, 256, 128, 2, 4, 1, /*UseUltra=*/true>(
        XQ, WQ, x_scale, w_scale, output, global_scale);
  } else if (mxfp4_block_size == 16) {
    return _f4f4bf16<MXFP4_16, 256, 128, 2, 4, 1, /*UseUltra=*/true>(
        XQ, WQ, x_scale, w_scale, output, global_scale);
  } else {
    return _f4f4bf16<MXFP4, 256, 128, 2, 4, 1, /*UseUltra=*/true>(
        XQ, WQ, x_scale, w_scale, output, global_scale);
  }
}
