...
import mslk.coalesce  # noqa: F401
import torch
from hypothesis import given, settings
from mslk.testing.attributes import gpu_unavailable  # noqa: F401
...
class CoalesceTest(unittest.TestCase):
    ...
    def test_coalesce_batches(
        ...
        torch.ops.mslk.coalesce_batches(inputs, inputs, old_bids, new_bids)
