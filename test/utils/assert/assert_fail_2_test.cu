...
__global__ void assert_conditional_fail_kernel(
  ...
  MSLK_KERNEL_ASSERT(!(blockIdx.x == bad_block && threadIdx.x == bad_thread));
}

////////////////////////////////////////////////////////////////////////////////
// MSLK_KERNEL_ASSERT DSA Failure Test
//
// These tests verify that MSLK_KERNEL_ASSERT correctly triggers Device-Side
...
TEST(MSLKKernelAssertTest, assert_conditional_fail_single_thread) {
  EXPECT_NO_THROW({
