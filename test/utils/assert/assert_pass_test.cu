...
__global__ void assert_condition_kernel(
  ...
  MSLK_KERNEL_ASSERT(data[idx] == expected);
}

// Kernel that asserts index bounds
__global__ void
assert_bounds_kernel(const int index, const int size, TORCH_DSA_KERNEL_ARGS) {
  MSLK_KERNEL_ASSERT(index >= 0 && index < size);
}

////////////////////////////////////////////////////////////////////////////////
// MSLK_KERNEL_ASSERT Tests
////////////////////////////////////////////////////////////////////////////////

TEST(MSLKKernelAssertTest, assert_pass_does_not_throw) {
...
TEST(MSLKKernelAssertTest, assert_condition_pass) {
...
TEST(MSLKKernelAssertTest, assert_bounds_pass) {
