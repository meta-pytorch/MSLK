...
"""Python-side Meta (shape inference) implementations for Blackwell FMHA C++ ops.
...
def fmha_gen_fwd_meta(
    ...
    # These ops are only defined when the native library was built with
    # SM100+ (Blackwell) support
    pass
